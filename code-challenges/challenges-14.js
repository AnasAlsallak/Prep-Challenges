...
const replaceWords = (str) => {
    ...
    let indexOfI = words.indexOf("I"), indexOfAm = words.indexOf("am"), indexOfWas = words.indexOf("was");

    while (indexOfI >= 0) {
        words.splice(indexOfI, 1, "We");
        indexOfI = words.indexOf("I");
    }
    while (indexOfAm >= 0) {
        words.splice(indexOfAm, 1, "are");
        indexOfAm = words.indexOf("am");
    }
    while (indexOfWas >= 0) {
        words.splice(indexOfWas, 1, "were");
        indexOfWas = words.indexOf("was");
    }
